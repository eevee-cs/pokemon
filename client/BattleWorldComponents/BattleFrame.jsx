...
class BattleFrame extends Component {
  ...
  render() {
    const { opponent, player, toggleToWorld, fightInfo } = this.props;
    return (
...
export default connect(mapStateToProps, { infoReset, damageOnOpponent, effectOnPlayer, damageOnPlayer, drainOnOpponent })(BattleFrame);
